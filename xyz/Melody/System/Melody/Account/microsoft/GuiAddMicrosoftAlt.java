...
import xyz.Melody.System.Melody.Account.microsoft.I;
...
extends GuiScreen {
    ...
    public GuiAddMicrosoftAlt(GuiScreen guiScreen) {
        ...
        new I(this, "Add MicrosoftAlt Thread").start();
    }
    ...
    static TimerUtil access$000(GuiAddMicrosoftAlt guiAddMicrosoftAlt) {
        return guiAddMicrosoftAlt.timer;
    }

    static MicrosoftLogin access$102(GuiAddMicrosoftAlt guiAddMicrosoftAlt, MicrosoftLogin microsoftLogin) {
        guiAddMicrosoftAlt.microsoftLogin = microsoftLogin;
        return guiAddMicrosoftAlt.microsoftLogin;
    }

    static MicrosoftLogin access$100(GuiAddMicrosoftAlt guiAddMicrosoftAlt) {
        return guiAddMicrosoftAlt.microsoftLogin;
    }

    static String access$202(GuiAddMicrosoftAlt guiAddMicrosoftAlt, String string) {
        guiAddMicrosoftAlt.message = string;
        return guiAddMicrosoftAlt.message;
    }

    static boolean access$302(GuiAddMicrosoftAlt guiAddMicrosoftAlt, boolean bl) {
        guiAddMicrosoftAlt.closed = bl;
        return guiAddMicrosoftAlt.closed;
    }
}
