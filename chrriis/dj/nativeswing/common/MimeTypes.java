...
public class MimeTypes {
    private static Map extensionToMimeTypeMap = new HashMap();
    ...
    public static String getMimeType(String string) {
        ...
        Map map = extensionToMimeTypeMap;
        // MONITORENTER : map
        // MONITOREXIT : map
        return (String)extensionToMimeTypeMap.get(string);
    }

    public static void addMissingMimeType(String string, String string2) {
        if (string == null) {
            return;
        }
        if (string.startsWith(".")) {
        ...
        Map map = extensionToMimeTypeMap;
        synchronized (map) {
            extensionToMimeTypeMap.put(string, string2);
        }
    }
