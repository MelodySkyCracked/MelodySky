...
extends AnnotatedMixinElementHandler {
     ...
     */
    public void registerOverwrite(AnnotatedElementOverwrite var1) {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl35 : ALOAD_3 - null : trying to set 2 previously set to 0
    ...
    extends AnnotatedMixinElementHandler.AnnotatedElement {
        public AnnotatedElementOverwrite(ExecutableElement executableElement, AnnotationHandle annotationHandle) {
