...
public class ST {
    public static final int LINE_UP = 0x1000001;
    public static final int LINE_DOWN = 0x1000002;
    public static final int LINE_START = 0x1000007;
    public static final int LINE_END = 0x1000008;
    public static final int COLUMN_PREVIOUS = 0x1000003;
    public static final int COLUMN_NEXT = 0x1000004;
    ...
    public static final int WORD_NEXT = 0x1040004;
    ...
    public static final int SELECT_LINE_UP = 0x1020001;
    public static final int SELECT_LINE_DOWN = 0x1020002;
    ...
    public static final int SELECT_WINDOW_END = 0x1060006;
    ...
    public static final int TOGGLE_OVERWRITE = 0x1000009;
    public static final int TOGGLE_BLOCKSELECTION = 0x100000A;
